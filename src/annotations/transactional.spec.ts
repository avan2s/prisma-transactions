...
describe('Example Test', () => {
  ...
  let prismaClient = new PrismaClient({ datasources: { db: { url: 'postgresql://postgres:postgres@localhost:6005/postgres' } }, log: ['query'] })
  ...
  it('should return the expected result', async () => {
    ...
    const user2 = await prismaClient.appUser.create({
      data: {
